...
<% 
		...
		try{				
			...
			{				
				...
				rs=stat.executeQuery("select * from course Where course_year='2017' and course_session= '1'");				
%> 				
...
<body>
	...
	<div class='toolbar'>
		...
		<form id='form' action='' method="post">
			...
			<input type="hidden" id="sid" name="sid" value="2b5f055e-dec4-41b8-a619-aa19066eeb24" />
			...
			<table style='width:100%; margin-top:15px'>
				...
				<tr>
					...
					<td>
						<input type="text" name="kkxy" id="kkxy" value="<%if(fliter==true) out.print(request.getParameter("kkxy"));%>" />
					</td>
					<td>
	...
	<div id='content'>
		<h3 style='margin-top:1em'>全校开课计划； 
